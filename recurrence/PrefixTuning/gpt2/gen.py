...
if __name__ == '__main__':
    ...
    if MODEL_FILE == 'gpt2-large':
        COMMANDLINE += ' --cache_dir ../../../gpt2-model/gpt2-large-s3 '

    if MODEL_FILE == 'gpt2':
        COMMANDLINE += ' --cache_dir ../../../gpt2-model/gpt2-s3 '

    if MODEL_FILE == 'gpt2-xl':
        COMMANDLINE += ' --cache_dir ../../../gpt2-model/gpt2-xl-s3 '

    if MODEL_FILE == 'gpt2-medium':
        COMMANDLINE += ' --cache_dir ../../../gpt2-model/gpt2-medium-s3 '
