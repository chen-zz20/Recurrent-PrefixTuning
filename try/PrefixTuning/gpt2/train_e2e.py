...
if __name__ == '__main__':
    ...
    # Added by MX
    parser.add_argument('--cache_dir', type=str, default='/home/chenzz/bighomework/gpt-model', help='cache dir')# 这里要链接到正确的gpt2model地址
    ...
    elif args.notes is not None and 'small' in args.notes:
        OLD_MODEL = "gpt2"
    elif args.notes is not None and 'xl' in args.notes:
        OLD_MODEL = "gpt2-xl"
    else:
    ...
    if OLD_MODEL == 'gpt2-large':
        ...
        app += f' --cache_dir {Path(args.cache_dir) / "gpt2-s3"} '
    
    elif OLD_MODEL == 'gpt2-xl':
        app += f' --cache_dir {Path(args.cache_dir) / "gpt2-xl-s3"} '
