...
if __name__ == '__main__':
    ...
    if mode =='data2text':
        ...
        if 'finetune' in sub_model_name:
            ...
            elif 'small' in sub_model_name:
                MODEL_FILE = 'gpt2'
            elif 'xl' in sub_model_name:
                MODEL_FILE = 'gpt2-xl'
            else:
    ...
    if MODEL_FILE == 'gpt2-large':
        COMMANDLINE += ' --cache_dir /home/chenzz/bighomework/gpt-model/gpt2-large-s3 '

    if MODEL_FILE == 'gpt2':
        COMMANDLINE += ' --cache_dir /home/chenzz/bighomework/gpt-model/gpt2-s3 '

    if MODEL_FILE == 'gpt2-xl':
        COMMANDLINE += ' --cache_dir /home/chenzz/bighomework/gpt-model/gpt2-xl-s3 '

    if MODEL_FILE == 'gpt2-medium':
        COMMANDLINE += ' --cache_dir /home/chenzz/bighomework/gpt-model/gpt2-medium-s3 '
