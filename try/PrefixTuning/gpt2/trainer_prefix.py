...
from jittor.dataset import RandomSampler, Sampler, SequentialSampler
...
from transformers.utils import logging # notorch
...
#TODO: torch->nn
control_Map = [jt.int64([3967]), jt.int64([4633]), jt.int64([8500])]
sst_lst = [(0, 2), (1, 3), (4,)]
...
def torch_distributed_zero_first(local_rank: int):
    ...
    """
    #TODO: torch->jittor, NOT ENABLED DISTRIBUTED
...
# distriuted not supported for jittor
...
class Trainer_Prefix:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.gpt2 = model_gpt2 if model_gpt2 is not None else None
        ...
        # HELP overload collate_batch
        Dataset.collate_batch = self.data_collator
    ...
    #TODO: torch->jittor
    def _get_train_sampler(self) -> Optional[jt.dataset.Sampler]:
        return (
    ...
    def get_train_dataloader(self) -> Dataset:
        ...
        self.train_dataset.sampler = train_sampler
        return self.train_dataset.set_attrs(
    ...
    #TODO: torch->jittor
    def _get_eval_sampler(self, eval_dataset: Dataset) -> Optional[jt.dataset.Sampler]:
        return SequentialSampler(eval_dataset)

    def get_eval_dataloader(self, eval_dataset: Optional[Dataset] = None) -> Dataset:
        """
    ...
    def num_examples(self, dataloader: Dataset) -> int:
        """
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        if (
            ...
            self.optimizer.load_state_dict(
                jt.load(os.path.join(model_path, "optimizer.pt"))
            )
    ...
    def compute_loss(self, model, inputs, gpt2_model=None):
        ...
        if 'prompt_lab' in inputs:
            ...
            for_inputs = []
            for index in prompt_lab_:
                for_inputs.append(k[index,:])
            inputs['control_code'] = jt.stack(for_inputs)
    ...
    def compute_loss_distill(self, model, inputs, gpt2_model=None):
        """
        How the loss is computed by Trainer. By default, nnall models return the loss in the first element.
