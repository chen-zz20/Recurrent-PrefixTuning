...
from transformers import (
    ...
    AutoConfig, # no torch
    AutoModelWithLMHead, # no torch
    AutoTokenizer, # no torch
    DataCollatorForPermutationLanguageModeling, # torch->jittor
    DataCollatorForData2TextLanguageModeling, #modified # torch->jittor
    HfArgumentParser, # no torch
    LineByLineData2TextTextDataset, # modified # torch->jittor
    LineByLineWebNLGTextDataset,# modified # torch->jittor
    PreTrainedTokenizer, # no torch
    TextDataset, # torch->jittor
    Trainer, # torch->jittor 
    TrainingArguments, # torch->jittor 
    set_seed, # torch->jittor ? is_torch_available属性
    GPT2LMHeadModel, # torch->jittor
    GPT2LMHeadModelAdapter, # torch->jittor
)
