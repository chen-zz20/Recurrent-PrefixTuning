...
class PrefixTuning(GPT2PreTrainedModel):
    ...
    def __init__(self, config, model_gpt2, optim_prefix=False, preseqlen=5, use_infix=False, deep_param=False):
        ...
        if True:
            ...
            # DIFFERENT PARAMETRIZATION:
                ...
                if self.init_shallow_word is not None:
                    ...
                    init_val = self.get_gold_init(model_gpt2, jt.int64(self.init_shallow_word))
                    print(init_val.shape)
                    self.control_trans = init_val
                    ...
                    self.control_trans = jt.init.gauss(self.preseqlen * config.n_layer * 2 * config.n_embd, "float32", 0.0, 1.0)
        ...
        if low_data_init == 3:
            ...
            print('use pt for this tensor', jt.int64(self.lowdata_token))
            self.lowdata_init_train3(gpt2=model_gpt2, sample_input=jt.int64(self.lowdata_token))
    ...
    def get_prompt_p5_infix(self, src, control_code=None, gpt2=None, bsz=None, attn_mask=None):
        ...
        zero_mask = jt.zeros(nl, nb, nh, src_len, ndim)# .to(self.device)
    ...
    def forward_infix(self,
        ...
        **kwargs,
        ...
        if self.mode_para == 2:
            ...
            infix_attn = jt.ones(bsz, self.preseqlen).bool()# .to(self.device)
