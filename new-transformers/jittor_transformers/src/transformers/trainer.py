...
from jittor.dataset import Dataset,RandomSampler, Sampler, SequentialSampler
...
# TODO:always false?           if isinstance(train_dataloader, DataLoader) and isinstance(train_dataloader.sampler, DistributedSampler):
#                train_dataloader.sampler.set_epoch(epoch)
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    jt.optim.Optimizer.clip_grad_norm(model.parameters(), self.args.max_grad_norm)
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[jt.Var, Any]]) -> jt.Var:
        ...
        Args:
            model (:obj:`nn.Module`):
                The model to train.
            inputs (:obj:`Dict[str, Union[jt.Var, Any]]`):
        ...
        Return:
            :obj:`jt.Var`: The tensor with training loss on this batch.
        """
    ...
    def prediction_loop(
        ...
        for inputs in tqdm(dataloader, desc=description, disable=disable_tqdm):
            ...
            if logits is not None:
                ...
                temp_logits = nn.log_softmax(logits, dim=-1)
    ...
    def prediction_step(
        ...
        if 'weights' in inputs:
            ...
            weights = (jt.ones(weights.shape)/bsz).to(weights.device)
